...
const ExpenseSettlement = () => {
    ...
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<ExpenseSettlementValues>({
    ...
    return (
        <form className="rounded-2xl shadow-[0px_3px_10.3px_0px_#0000001A] bg-white p-5 space-y-5" >
            <div className="flex items-center gap-3" >
                ...
                <p className="text-[#0F1219] text-[22px] font-bold" > تصفية المصروفات </p>
            ...
            <div className="flex gap-3 justify-end" >
                <Button className="w-[165px] h-[47px] rounded-lg border border-[#C8C2FC] bg-white hover:bg-white text-[#101011] text-[20px]" >
                ...
                <MainButton text="تطبيق" icon={<Check className="w-5 h-5" />} className="!w-[130px]" />
            </div>
        </form>
    )
}
