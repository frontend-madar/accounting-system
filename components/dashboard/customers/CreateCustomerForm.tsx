             ...
             <FormSection title="بيانات العميل" >
                 <div>
                    <FieldLabel htmlFor={"clientType"} dropdown={false}>
                        <span className="text-[#232323] text-[18px] mb-2"> نوع العميل </span>
                    </FieldLabel>
            ...
            <div className="grid grid-cols-2 gap-4" dir="rtl">
                <div>
                    <FieldLabel htmlFor={"comments"} dropdown={false} >
                        <span className="text-[#232323] text-[18px] mb-2">ملاحظات </span>
                    </FieldLabel>
                    <Textarea
                        id="comments"
                ...
                <div>
                    <FieldLabel htmlFor={"comments"} dropdown={false} >
                        <span className="text-[#232323] text-[18px] mb-2"> المرفقات </span>
                    </FieldLabel>
                    <div
